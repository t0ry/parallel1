...
public final class ReciprocalArraySum {
    ...
    private static class ReciprocalArraySumTask extends RecursiveAction {
        ...
        protected void compute() {
            ...
            ReciprocalArraySumTask asyncTaskLo = new ReciprocalArraySumTask(this.startIndexInclusive, mid, this.input);
        	ReciprocalArraySumTask asyncTaskHi = new ReciprocalArraySumTask(mid, this.endIndexExclusive, this.input);
...
//                invokeAll(new ReciprocalArraySumTask(this.startIndexInclusive, mid, this.input),
